...
TODO Add software tab on the top of the blog.
...
To analyze EXIF metadata, I use [ExifTool](https://exiftool.org/), a powerful command-line utility that can extract metadata from virtually any image format. It supports a vast number of tags and is maintained by the photography and digital imaging community. ExifTool is especially useful for exploring maker-specific tags—metadata fields that camera manufacturers add on top of the standard EXIF specification.
...
This analysis shows how metadata can reveal structured shooting modes, even when timestamps of the shots are quite close. TODO Refrase the last wording.
...
TODO include a Call to Action like:
